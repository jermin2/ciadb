    ...
    <div class="card-body">
        <form method="POST" class="col-md-8 m-auto" action="{{ route('login') }}">
            ...
            <div class="input-group my-4">
                ...
                <input type="text" class="form-control form-control-lg" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>
            ...
            <div class="form-group mb-0 row">
                <button type="submit" class="col btn btn-lg btn-primary py-2 m-1">
                    {{ __('Login') }}
                </button>
                <a href="{{ route('register') }}" class="col btn btn-lg btn-secondary py-2 m-1">
                    Register
                </a>
            </div>
            ...
            <div class="form-group row mb-0">          
                <a href="{{ url('/redirect') }}"  class="btn col-md-12"  ><img id="google" style="max-height:52px" src="{{URL::asset('images/btn_normal.png')}}" ></a>
            </div>
        </form>
    </div>
