...
<head>
    ...
    <link href="{{ asset('css/all.css?') }}{{date('l jS \of F Y h:i:s A')}}" rel="stylesheet">
...
<body>
        ...
        <div id="sidebar" onmouseenter="sidebarMouseenter()" onmouseleave="sidebarMouseleave()" class="sidebar">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li class="profile"> <a href="#profileSubmenu" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                        ...
                        <ul class="collapse list-unstyled subnav show" id="profileSubmenu">
                            <li class="profile my-profile">
                                ...
                                <a href="{{ route('people.edit', Auth::user()->person->id) }}">
                                @else
                                <a href="">
                                @endif
                    ...
                    @can('show_events')
                    <li> 
                        <a href="#pivotSubmenu" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle pivot">
                        <svg class="bi bi-calendar icon icon-header" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M14 0H2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z" clip-rule="evenodd"/>
                            <path fill-rule="evenodd" d="M6.5 7a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>
                        </svg><span>Pivot</span></a> 
                        <ul class="collapse list-unstyled subnav show" id="pivotSubmenu">
                            @can('create_events')
                            <li class="pivot index">
                                <a href="{{route('event.person.index')}}"><svg class="bi bi-plus-square icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M8 3.5a.5.5 0 01.5.5v4a.5.5 0 01-.5.5H4a.5.5 0 010-1h3.5V4a.5.5 0 01.5-.5z" clip-rule="evenodd"/>
                                <path fill-rule="evenodd" d="M7.5 8a.5.5 0 01.5-.5h4a.5.5 0 010 1H8.5V12a.5.5 0 01-1 0V8z" clip-rule="evenodd"/>
                                <path fill-rule="evenodd" d="M14 1H2a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V2a1 1 0 00-1-1zM2 0a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2H2z" clip-rule="evenodd"/>
                                </svg>
                                <span>Pivot Table</span></a>
                            </li>
                            @endcan
                        </ul> 
                    </li>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/app.js?9') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            if(location.href.includes("people")){
                ...
                selector1 = ".dashboard";
            } else if(location.href.includes("pivot")){
                selector1 = ".pivot";
            } else {
